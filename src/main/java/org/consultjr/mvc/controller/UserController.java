...
public class UserController extends AppController implements CRUDable {
    ...
    @RequestMapping(value = "/addClient", method = RequestMethod.GET) // GET: /PROJECT/User/add
    public ModelAndView addClient() {
        ModelAndView modelAndView = new ModelAndView("User/_clientform");
        User user = new User();
        modelAndView.addObject("user", user);
        modelAndView.addObject("action", "addClient");
        modelAndView.addObject("userID", null);
        return modelAndView;
    }

    @RequestMapping(value = "/addClient", method = RequestMethod.POST) // Save Method: POST /PROJECT/User/add
    public ModelAndView addUserClient(@ModelAttribute User user) {
        ModelAndView modelAndView = new ModelAndView("User/_clientform");
